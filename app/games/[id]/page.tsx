  ...
  if (!game) {
    return (
      <Box textAlign="center" py="20">
        <Heading size="lg" color="red.500">Game not found</Heading>
        <Text color="fg.muted">The game ID {id} does not exist in our database.</Text>
      </Box>
    );
  }
        ...
        <HStack justify="space-between" wrap="wrap">
            <Stack gap="1">
                <HStack gap="3" align="center">
                    ...
                    <Badge size="lg" colorPalette={game.status === 'Live' ? 'green' : 'yellow'}>
                        {game.status}
                    </Badge>
                </HStack>
                <Text color="fg.muted" fontSize="lg">{game.franchise} • {game.genre}</Text>
            </Stack>
            <HStack>
                <Badge variant="surface" size="lg">Release: {game.releaseDate}</Badge>
                <Badge variant="surface" size="lg" colorPalette="blue">Rating: {game.rating}</Badge>
            </HStack>
        </HStack>
      </Stack>
      ...
      <SimpleGrid columns={{ base: 1, md: 2, lg: 4 }} gap="6" mb="8">
        ...
        <Card.Root>
            <Card.Body>
                ...
                <Text fontSize="3xl" fontWeight="bold">{game.metrics.avgPlaytime}h</Text>
            </Card.Body>
        </Card.Root>
        <Card.Root>
            <Card.Body>
                ...
                <Text fontSize="3xl" fontWeight="bold">{game.metrics.retention}%</Text>
            </Card.Body>
        </Card.Root>
      </SimpleGrid>
